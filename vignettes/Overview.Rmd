...
Simulation results have been archived on Zenodo (Efford 2025). We retrieve them with the R package **zen4R** (Blondel 2024).

```{r zenodo, eval = TRUE, echo = TRUE}
require(zen4R)
tmpfolder <- tempdir()
...
Next code chunk loads each set of simulations, restoring the objects that were 
created (offline) by running preceding chunks.
