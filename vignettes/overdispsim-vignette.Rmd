...
```{r samplingonly, eval = runsimulations, cache = TRUE, warning = FALSE, message = FALSE}
# Poisson N(A)
...
```{r modelfits, eval = runsimulations, cache = TRUE, warning = FALSE, message = FALSE}
# Poisson N(A)
...
```{r CLfit, eval = runsimulations, cache = TRUE, warning = FALSE, message = FALSE}
# Poisson N
...
```{r cohesion, eval = runsimulations, cache = TRUE, warning = FALSE, message = FALSE}
